<?php
	...
	if(isset($_POST['show_btn'])){
		...
		$query = "DELETE FROM reserves  WHERE LicensePlate='$LicensePlate' and StartDate='$StartDate' ";
...
<html>
	...
	<body>
	<div class="header">
		<h1><p>Delete a reservation </p></h1>
		<div id=home>
		<ul>
	...
	<p>Insert the License Plate and the Start Date of the reservation you want to delete:</p>
